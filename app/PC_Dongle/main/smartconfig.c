...
static esp_err_t event_handler(void *ctx, system_event_t *event)
{
    ...
    case SYSTEM_EVENT_AP_PROBEREQRECVED:
        eloop_log(1,"event_handler:prober recieve rssi:%d \r\n",event->event_info.ap_probereqrecved.rssi);
        //eloop_logb(1," From:",event->event_info.ap_probereqrecved.mac,6);
		break;
    default:
        break;
    }
...
void initialise_wifi(void)
{
	...
	if((strlen((char*)sta_conf.sta.ssid)==0)||(strlen((char*)sta_conf.sta.password)==0))
	{
